% Taken from: https://se.mathworks.com/help/images/neural-style-transfer-using-deep-learning.html
% Calculate Image Loss and Gradients
% The imageGradients helper function returns the loss and gradients using features of the content image, 
% style image, and transfer image.
